...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "Über uns — Taxi Team Esslingen" },
      { name: "description", content: "Familienbetrieb für Taxi in Esslingen am Neckar seit 1998 — für Anwohner, Unternehmen und Reisende." },
      { property: "og:title", content: "Über Taxi Team Esslingen" },
      { property: "og:description", content: "Familienbetrieb für Taxi in Esslingen am Neckar seit 1998." },
      ...
      <Section>
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="space-y-4 text-base text-muted-foreground">
            <p>{t("about_p1")}</p>
            <p>{t("about_p2_pre")}<strong className="text-foreground">{t("about_p2_strong")}</strong>{t("about_p2_post")}</p>
            <p>{t("about_p3")}</p>
          </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={title} className="rounded-2xl border border-border bg-card p-6 shadow-soft">
              <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-xl gradient-brand text-brand-foreground"><Icon className="h-5 w-5" /></div>
