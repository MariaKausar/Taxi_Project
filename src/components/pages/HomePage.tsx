  ...
  return (
    <section className="relative overflow-hidden bg-primary">
      <div className="absolute inset-0">
        <Image
          src={heroImg}
          alt="Taxi in Esslingen am Neckar"
          fill
          priority
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_minmax(360px,440px)] lg:gap-12 lg:py-28 lg:px-8">
        <div className="text-primary-foreground">
          ...
          <h1 className="font-display text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl text-balance-tight">
            {t("hero_title_pre")}
            <span className="text-brand">{t("hero_title_city")}</span>
            {t("hero_title_post")}
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/booking"
              className="group inline-flex items-center gap-2 rounded-full gradient-brand px-6 py-3.5 text-sm font-bold text-brand-foreground shadow-glow transition hover:scale-[1.03]"
            >
              {t("hero_cta_book")}
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-6 py-3.5 text-sm font-bold text-primary-foreground backdrop-blur transition hover:bg-white/20"
            >
      ...
      <div className="overflow-hidden rounded-3xl bg-primary p-10 text-primary-foreground sm:p-14">
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-wrap gap-3 lg:justify-end">
            <a
              href="tel:+491785183559"
              className="inline-flex items-center gap-2 rounded-full gradient-brand px-6 py-3.5 text-sm font-bold text-brand-foreground shadow-glow"
            >
              <Phone className="h-4 w-4" /> +49 1785 183559
            </a>
            <Link
              href="/booking"
              className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-6 py-3.5 text-sm font-bold backdrop-blur hover:bg-white/20"
            >
